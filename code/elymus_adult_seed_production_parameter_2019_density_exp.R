...
Y_P_fun <- function(disease, A_dens, S_dens, P_dens, iter) {
  
  # calculate survival
  Y_P <- ifelse(disease == 1, 
                     Y_P_dens$int_wat[iter] / (1 + Y_P_dens$mv_dens_wat[iter] * A_dens + Y_P_dens$evS_dens_wat[iter] * S_dens + Y_P_dens$evA_dens_wat[iter] * P_dens),
                     Y_P_dens$int_fun[iter] / (1 + Y_P_dens$mv_dens_fun[iter] * A_dens + Y_P_dens$evS_dens_fun[iter] * S_dens + Y_P_dens$evA_dens_fun[iter] * P_dens))
