...
Y_P_fun <- function(disease, g.A, E.A, A_dens, g.S, E.S, S_dens, P_dens, iter) {
  ...
  Y_P <- ifelse(disease == 1, 
                     Y_P_dens$int_wat[iter] / (1 + Y_P_dens$mv_dens_wat[iter] * g.A * E.A * A_dens + Y_P_dens$evS_dens_wat[iter] * g.S * E.S * S_dens + Y_P_dens$evA_dens_wat[iter] * P_dens),
                     Y_P_dens$int_fun[iter] / (1 + Y_P_dens$mv_dens_fun[iter] * g.A * E.A * A_dens + Y_P_dens$evS_dens_fun[iter] * g.S * E.S * S_dens + Y_P_dens$evA_dens_fun[iter] * P_dens))
