...
pdf("output/annual_perennial_kortessis_outcomes_rel_abund_2019_density_exp.pdf", width = 4.5, height = 3)
cdat %>%
...
#### output ####
write_csv(cdat, "output/annual_perennial_kortessis_relative_abundance_constants_2019_density_exp.csv")
write_csv(tdat, "output/annual_perennial_kortessis_relative_abundance_time_series_2019_density_exp.csv")
write_csv(pdat, "output/annual_perennial_kortessis_relative_abundance_parameters_2019_density_exp.csv")
