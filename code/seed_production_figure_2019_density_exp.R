...
# import figures
load("output/elymus_seedling_seed_figure_2019_density_exp.rda")
load("output/elymus_adult_seed_figure_2019_density_exp.rda")
load("output/microstegium_seed_figure_2019_density_exp.rda")
...
pdf("output/seed_production_figure_2019_density_exp.pdf", width = 6, height = 7)
plot_grid(mvSeedD2Fig, evSSeedD2Fig, evASeedD2Fig,
