...
Y_S_fun <- function(disease, A_dens, S_dens, P_dens, iter) {
  
  # calculate survival
  Y_S <- ifelse(disease == 1, 
                     Y_S_dens$int_wat[iter] / (1 + Y_S_dens$mv_dens_wat[iter] * A_dens + Y_S_dens$evS_dens_wat[iter] * S_dens + Y_S_dens$evA_dens_wat[iter] * P_dens),
                     Y_S_dens$int_fun[iter] / (1 + Y_S_dens$mv_dens_fun[iter] * A_dens + Y_S_dens$evS_dens_fun[iter] * S_dens + Y_S_dens$evA_dens_fun[iter] * P_dens))
