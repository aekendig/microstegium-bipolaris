...
growth_mod_parms2 <- growth_mod_parms %>%
  mutate(Estimate = case_when(substr(Parameter, 1, 5) == "alpha" & substr(Parameter, 8,8) == "A" ~ 0.001, # alpha adjustments
                              substr(Parameter, 1, 5) == "alpha" & substr(Parameter, 8, 8) == "P" ~ 0.0065,
                                 TRUE ~ Estimate))
