...
Y_S_fun <- function(disease, g.A, E.A, A_dens, g.S, E.S, S_dens, P_dens, iter) {
  ...
  Y_S <- ifelse(disease == 1, 
                     Y_S_max / (1 + Y_S_dens$mv_dens_wat[iter] * g.A * E.A * A_dens + Y_S_dens$evS_dens_wat[iter] * g.S * E.S * S_dens + Y_S_dens$evA_dens_wat[iter] * P_dens),
                     Y_S_max / (1 + Y_S_dens$mv_dens_fun[iter] * g.A * E.A * A_dens + Y_S_dens$evS_dens_fun[iter] * g.S * E.S * S_dens + Y_S_dens$evA_dens_fun[iter] * P_dens))
