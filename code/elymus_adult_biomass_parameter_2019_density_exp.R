...
B_P_fun <- function(disease, A_dens, S_dens, P_dens, iter) {
  
  # calculate survival
  B_P_expr <- ifelse(disease == 1, 
                     B_P_dens$int_wat[iter] - log(1 + B_P_dens$mv_dens_wat[iter] * A_dens + B_P_dens$evS_dens_wat[iter] * S_dens + B_P_dens$evA_dens_wat[iter] * P_dens),
                     B_P_dens$int_fun[iter] - log(1 + B_P_dens$mv_dens_fun[iter] * A_dens + B_P_dens$evS_dens_fun[iter] * S_dens + B_P_dens$evA_dens_fun[iter] * P_dens))
