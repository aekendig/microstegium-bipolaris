...
mvSeedD2Mod2 <- update(mvSeedD2Mod1, chains = 3,
                     control = list(adapt_delta = 0.999))
summary(mvSeedD2Mod2)
plot(mvSeedD2Mod2)
pp_check(mvSeedD2Mod2, nsamples = 50)
...
#### output ####
save(mvSeedD2Mod2, file = "output/microstegium_seed_model_2019_density_exp.rda")
save(mvSeedD2Plot, file = "output/microstegium_seed_figure_2019_density_exp.rda")
