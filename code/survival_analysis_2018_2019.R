...
# compare fits
mgSGrpSumSurvLoo <- loo(mvSGrpSumSurvMod3, mvSGrpSumSurvMod5, reloo = T)
mgSGrpSumSurvLoo
...
#### Mv summer survival: density and fungicide effects ####
...
# simulate fit
mvSSumSurvD2Fit <- tibble(mv_seedling_density = c(seq(0, 64, length.out = 100), rep(0, 200)),
...
save(mgSGrpSumSurvLoo, file = "output/mv_seedling_survival_all_data_model_comparison.rda")
